...
function Form() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("/api/solicitud-viaje", {
        method: "POST",
        headers: {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-gray-500 max-w-2xl mx-auto">
            Completa el formulario con los detalles de tu viaje y me pondré en
            contacto contigo para ayudarte a encontrar la mejor opción.
          </p>
        </div>
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                >
                  ...
                  <option value="US$500 - US$1,000">US$500 - US$1,000</option>
                  ...
                  <option value="Más de US$5,000">Más de US$5,000</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            >
              ...
              <option value="Viaje en pareja">Viaje en pareja</option>
